...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=simpleTutorial.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x72, 0x69, 0x61, 0x6c, 0x22, 0xaf, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d, 0x6f, 0x72,
	...
	0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x54, 0x75,
	0x74, 0x6f, 0x72, 0x69, 0x61, 0x6c, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x2e, 0x55, 0x6e,
	...
	0x52, 0x41, 0x42, 0x59, 0x54, 0x45, 0x10, 0x06, 0x42, 0x13, 0x5a, 0x11, 0x70, 0x62, 0x2f, 0x73,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: simpleTutorial.Memory.Unit
	(*Memory)(nil),   // 1: simpleTutorial.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: simpleTutorial.Memory.unit:type_name -> simpleTutorial.Memory.Unit
